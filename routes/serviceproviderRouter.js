...
const { changeRole, addRental, getserviceproviderData, toggleRentalAvailability, deleteRental, submitDetails, getData } = require("../controllers/serviceproviderController");
...
serviceproviderRouter.get("/data", protect, getData);
